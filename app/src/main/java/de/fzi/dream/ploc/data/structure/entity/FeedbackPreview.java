...
@Entity(tableName = "feedback_preview_cache")
public class FeedbackPreview extends BaseObservable {
    @PrimaryKey
    @NonNull
    ...
    public FeedbackPreview(int id, String title, int year, String creators, String teaser, int type, boolean visited, List<String> subjectKeywords) {
        this.id = id;
        this.title = title;
        this.year = year;
