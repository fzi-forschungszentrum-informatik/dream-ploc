...
/**
 * The RecordBookmarkSwipeCallback provides the callback functionality to response to the users
 * swipes on {@link CardView}s within the {@link RecordBookmarkFragment} and its {@link RecyclerView}.
 * It is also responsibly for the layout and style of the background displayed when a card is swiped.
 *
 * @author Felix Melcher
 */
public class RecordBookmarkSwipeCallback extends ItemTouchHelper.Callback {

    /**
     * Public class identifier tag
     */
    public static final String TAG = RecordBookmarkSwipeCallback.class.getSimpleName();

    private OnRecordBookmarkCardInteraction mListener;
     ...
     */
    public RecordBookmarkSwipeCallback(OnRecordBookmarkCardInteraction l) {
        mListener = l;
    }
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        mListener.onCardLeftSwipe(((RecordBookmarkViewHolder) viewHolder).getBookmark(), viewHolder.getAdapterPosition());
    }
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        if (actionState == ItemTouchHelper.ACTION_STATE_SWIPE) {
            ...
            if (dX > 0) {
                ...
                icon = getBitmapFromDrawable(recyclerView.getContext(), R.drawable.ic_star_darkgrey_24dp);
            } else {
                ...
                icon = getBitmapFromDrawable(recyclerView.getContext(), R.drawable.ic_delete_white_24dp);
            }
