...
public class FeedbackGetRecord extends BaseObservable {
   // @PrimaryKey
    @NonNull
  //  @ColumnInfo(name = "record_id")
   ...
   // @ColumnInfo(name = "subject_keywords")
    ...
    public FeedbackGetRecord(String title, String status){
        this.title = title;
        this.teaser = status;
    }

    public FeedbackGetRecord(int id, String title, int year, List<String> creators, String teaser, int type, boolean isNew, List<String> subjectKeywords) {
        this.id = id;
        this.title = title;
        this.year = year;
