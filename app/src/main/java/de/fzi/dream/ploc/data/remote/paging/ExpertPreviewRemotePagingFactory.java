...
/**
 * The ExpertPreviewRemotePagingFactory provides a way to observe the remote
 ...
 */
public class ExpertPreviewRemotePagingFactory extends DataSource.Factory<PageKey, ExpertPreview> {

    /** Public class identifier tag for logging */
    public static final String TAG = ExpertPreviewRemotePagingFactory.class.getSimpleName();

    private MutableLiveData<ExpertPreviewRemotePagingSource> mNetworkStatus;
    private ExpertPreviewRemotePagingSource mPagingSource;
     ...
     */
    public ExpertPreviewRemotePagingFactory(MutableLiveData<String> searchTerm) {
        mSearchTerm = searchTerm;
        mNetworkStatus = new MutableLiveData<>();
        mPagingSource = new ExpertPreviewRemotePagingSource(searchTerm);
    }
     ...
     */
    @Override
    public DataSource<PageKey, ExpertPreview> create() {
        if (mPagingSource == null || mPagingSource.isInvalid()) {
            mPagingSource = new ExpertPreviewRemotePagingSource(mSearchTerm);
        }
     ...
     */
    public MutableLiveData<ExpertPreviewRemotePagingSource> getNetworkStatus() { return mNetworkStatus; }
     ...
     *
     * @return ReplaySubject observable list of experts
     */
    public ReplaySubject<ExpertPreview> getExperts() { return mPagingSource.getExperts(); }
}